...
const MAS_AIRAGA = {
  ...
  rental_contract: {
    ...
    // Tourist tax — Terre de Provence Agglomeration (meuble non classe)
    // Source: https://terredeprovence.taxesejour.fr/
    // Calculation: 5% of price/person/night (capped at 3.18 EUR/person/night),
    // + 10% departmental addition (Bouches-du-Rhone),
    // + 34% regional addition (Ligne Nouvelle Provence Cote d'Azur, since 2023-01-01).
    // Total per adult per night = base + departmental + regional. Children under 18 exempt.
    tourist_tax_proportional_rate: 0.05,
    tourist_tax_cap_per_person_per_night: 3.18,
    tourist_tax_departmental_rate: 0.10,
    tourist_tax_regional_rate: 0.34,
    tourist_tax_authority_fr: "Terre de Provence Agglom\u00e9ration",
    tourist_tax_authority_en: "Terre de Provence Agglomeration",
    clauses_fr: [
      ...
      { title: "Taxe de sejour", text: "Conformement a la legislation francaise, une taxe de sejour est due par chaque occupant adulte pour chaque nuit passee dans le logement. Pour les meubles de tourisme non classes du territoire de Terre de Provence Agglomeration, le montant correspond a 5 % du prix par personne et par nuit (plafonne a 3,18 EUR par personne et par nuit), augmente de 10 % de taxe additionnelle departementale (Bouches-du-Rhone) et de 34 % de taxe additionnelle regionale (Ligne Nouvelle Provence Cote d'Azur). Les mineurs de moins de 18 ans sont exoneres. Cette taxe est collectee par le bailleur pour le compte de Terre de Provence Agglomeration, qui en est l'autorite percevante. Le detail du calcul figure dans le recapitulatif financier ci-dessus." },
    ...
    clauses_en: [
      ...
      { title: "Tourist tax", text: "In accordance with French law, a tourist tax (taxe de sejour) is due per adult occupant per night spent at the property. For non-classified furnished tourist accommodation in the Terre de Provence Agglomeration territory, the amount equals 5% of the price per person per night (capped at 3.18 EUR per person per night), plus a 10% departmental addition (Bouches-du-Rhone) and a 34% regional addition (Provence Cote d'Azur New Line). Persons under 18 are exempt. This tax is collected by the landlord on behalf of Terre de Provence Agglomeration, the receiving authority. The detailed breakdown is shown in the financial summary above." },
