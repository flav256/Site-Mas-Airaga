...
const translations = {
  fr: {
    ...
    "access-times": "Saint-Rémy : 4 km · Avignon : 15 min · Avignon TGV : 20 min · Arles : 30 min · Aéroport Marseille : 1h",
    ...
    "around-eyragues-title": "🏡 Eyragues - Notre Village",
    ...
    "around-eyragues-tourism-desc": "Informations touristiques officielles et visites guidées d'Eyragues",
    "around-events-title": "Calendrier des Événements",
    "around-events-desc": "Tous les événements et loisirs de la région. Agenda culturel",
  ...
  en: {
    ...
    "access-times": "Saint-Rémy: 4 km · Avignon: 15 min · Avignon TGV: 20 min · Arles: 30 min · Marseille Airport: 1h",
    ...
    "around-eyragues-title": "🏡 Eyragues - Our Village",
    ...
    "around-villages-desc": "Les Baux-de-Provence, Saint-Rémy, Arles, Avignon and their Provencal markets",
  ...
  nl: {
    ...
    "access-times": "Saint-Rémy: 4 km · Avignon: 15 min · Avignon TGV: 20 min · Arles: 30 min · Luchthaven Marseille: 1u",
    ...
    "around-eyragues-title": "🏡 Eyragues - Ons Dorp",
    ...
    "around-villages-desc": "Les Baux-de-Provence, Saint-Rémy, Arles, Avignon en hun Provençaalse markten",
    ...
    "around-eyragues-tourism-desc": "Officiële toeristische informatie en rondleidingen in Eyragues",
  ...
  de: {
    ...
    "access-times": "Saint-Rémy: 4 km · Avignon: 15 Min · Avignon TGV: 20 Min · Arles: 30 Min · Flughafen Marseille: 1 Std",
    ...
    "around-eyragues-title": "🏡 Eyragues - Unser Dorf",
    ...
    "around-villages-desc": "Les Baux-de-Provence, Saint-Rémy, Arles, Avignon und ihre provenzalischen Märkte",
    "around-culture-title": "Kultur & Lebenskunst",
    "around-culture-desc": "Weinkeller, Ölmühlen, Antiquitäten und lokale Gastronomie",
    "around-eyragues-terre-title": "Eyragues - Terre de Provence",
    "around-eyragues-terre-desc": "Authentisches Dorf in den Alpilles. Geschichte, Erbe und lokales Leben",
    "around-eyragues-tourism-title": "Tourismusbüro",
    "around-eyragues-tourism-desc": "Offizielle Touristeninformationen und Führungen durch Eyragues",
    "around-events-title": "Veranstaltungskalender",
    "around-events-desc": "Alle Veranstaltungen und Freizeitaktivitäten der Region. Kultureller Terminkalender",
...
function calculateBookingPrice() {
  ...
  // Last high-season NIGHT is 28/08; the guest therefore checks out on 29/08.
  // These two must stay distinct: comparing a checkout date against the last
  // night silently demoted the final week of August to standard pricing.
  ...
  // Starts in high season and runs past it (the calendar allows any checkout
  // day once the stay reaches September) — priced as high-season weeks + standard nights.
  ...
  if (isHighSeason) {
    ...
    if (checkin.getDay() !== 6) {
      errors.push(currentLang === 'fr'
        ? 'En haute saison, les arrivées doivent être le samedi.'
        : 'During high season, check-in must be on Saturday.');
    }
    ...
    if (highSeasonNights % 7 !== 0) {
      errors.push(currentLang === 'fr'
        ? 'La partie juillet/août doit être par semaine complète (7 jours).'
        : 'The July/August portion must be in full weeks (7 days).');
    }

    const highSeasonPrice = highSeasonWeeksPrice(Math.floor(highSeasonNights / 7));
